...
use crate::{hemicom, interrupts::Irqs, keyboard::KbEvents};

use super::{
    keyboard,
    serial::{self, UsbSerial},
    UsbEvent, MAX_PACKET_SIZE, USB_EVENTS,
};
